    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('manufacture', models.CharField(blank=True, max_length=30, verbose_name='Производитель')),
                ('width', models.DecimalField(decimal_places=0, max_digits=10, verbose_name='Ширина')),
                ('thickness', models.DecimalField(blank=True, decimal_places=2, max_digits=10, verbose_name='Толщина')),
